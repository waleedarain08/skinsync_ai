...
enum EndPoints {
  ...
  treatmentRequestGroups('v1/treatment-journey-groups'),
  updateTreatmentRequestGroups('v1/treatment-journey-group'),
  shareTreatmentRequest('v1/share-treatment-request'),
  shareMapTreatmentRequest('v1/invite-map-treatment-request'),
  treatmentRequestOptions('v1/treatment-journey-options'),
  deleteTreatmentRequestOptions('v1/treatment-journey-option'),
